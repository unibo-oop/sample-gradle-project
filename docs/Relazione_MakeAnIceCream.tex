...
\begin{itemize}
	...
	\item Ciascun livello dovrà prevedere un numero complessivo di clienti variabile, che aumenterà con il livello di difficoltà.
...
Gli elementi costitutivi del problema sono sintetizzati in \Cref{img:analysis}.
...
L'architettura del gioco Make an Ice Cream segue il pattern architetturale MVC, in particolare nella sua forma ‘ECB’, quindi il gioco è organizzato in tre componenti principali: la View (Boundary), il Controller e il modello (Entity). …


\subsection*{Esempio prof ecc.}
